...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_First
    {
       ...
       */
        ...
        {
            var ActualCohort = PracticeData.First(cohort => cohort.FullTime && cohort.PrimaryInstructor.Birthday.Year > 2018);
        ...
        {
            var shouldThrowException = PracticeData.First(cohort => !cohort.Active && !cohort.FullTime)/*FILL IN LINQ EXPRESSION*/;
        }
